...
struct Beer : Codable {
	...
	let volume : Measurement<Unit>?
	let boil_volume : Measurement<Unit>?
	let method : Method?
	...
	init(from decoder: Decoder) throws {
        ...
        volume = try values.decodeIfPresent(Measurement<Unit>.self, forKey: .volume)
        boil_volume = try values.decodeIfPresent(Measurement<Unit>.self, forKey: .boil_volume)
